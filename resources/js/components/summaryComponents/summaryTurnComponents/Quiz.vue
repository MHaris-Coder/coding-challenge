<template>
    <div class="container-fluid">
        <QuizLoadingComponent v-if="$store.state.LOADING"/>
...
<script>
    ...
    const QuizLoadingComponent = defineAsyncComponent(() =>
        import('./../../LoadingComponents/QuizLoading.vue')
    )
    ...
    export default {
        ...
        methods: {
            ...
            async selectAnswer(answer) {
                ...
                let payload = {
                    game_turn_id: this.LAST_GAME_TURN_DATA?.id,
                    question_id: this.QUESTION?.id,
                    answer_id: answer?.id,
                }
                this.$store.dispatch('createQuestionResult', payload)
            }
        },
        computed: {
            ...mapState({
                LAST_GAME_TURN_DATA: state => state.gameSettingsModule.LAST_GAME_TURN_DATA,
                QUESTION: state => state.gameSettingsModule.QUESTION,
            })
        },
    }
</script>
